...
namespace ExceptionHandlingExercise
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Doneset your string variable to each array element in your char[] to .ToString()
            // DoneNow, using int.Parse, parse your string variable and store in an int variable
